                            ...
                            uint8_t flags)
{
    ...
    else
    {
        ...
        case rr_petal_id_starfish:
            ...
            rr_renderer_set_fill(renderer, 0xff319E40);
            rr_renderer_begin_path(renderer);
            ...
            rr_renderer_bezier_curve_to(renderer, 19.25, 66.28, -18.94, 66.28,
                                        -42.50, 42.73);
            rr_renderer_fill(renderer);
            rr_renderer_set_fill(renderer, 0xff288034);
            rr_renderer_begin_path(renderer);
            ...
            rr_renderer_fill(renderer);
            break;
        case rr_petal_id_fangs:
        rr_renderer_scale(renderer, 0.08);
rr_renderer_translate(renderer, -245.054, -240.858);
rr_renderer_set_fill(renderer, 0xff777777);
rr_renderer_set_stroke(renderer, 0xff666666);
rr_renderer_set_line_width(renderer, 70);
rr_renderer_begin_path(renderer);
rr_renderer_move_to(renderer, 230.429, 71.723);
rr_renderer_quadratic_curve_to(renderer, 245.054, 60.89, 259.679, 71.723);
rr_renderer_line_to(renderer, 413.236, 185.472);
rr_renderer_quadratic_curve_to(renderer, 427.86, 196.305, 422.274, 213.833);
rr_renderer_line_to(renderer, 363.621, 397.882);
rr_renderer_quadratic_curve_to(renderer, 358.035, 415.41, 339.958, 415.41);
rr_renderer_line_to(renderer, 150.15, 415.41);
rr_renderer_quadratic_curve_to(renderer, 132.073, 415.41, 126.487, 397.882);
rr_renderer_line_to(renderer, 67.834, 213.833);
rr_renderer_quadratic_curve_to(renderer, 62.248, 196.305, 76.872, 185.472);
rr_renderer_line_to(renderer, 230.429, 71.723);
rr_renderer_fill(renderer);
rr_renderer_stroke(renderer);
        case rr_petal_id_meat:
  rr_renderer_scale(renderer, 1);
            rr_renderer_translate(renderer, -245.054, -240.858);
            rr_renderer_set_fill(renderer, 0xffede3c3);
            rr_renderer_set_stroke(renderer, 0xfff06a55);
            rr_renderer_set_line_width(renderer, 33);
            rr_renderer_begin_path(renderer);
rr_renderer_begin_path(renderer);
rr_renderer_move_to(renderer, 69.38, 62.19);
rr_renderer_bezier_curve_to(renderer, 69.38, 62.19, 85.51, -70.81, 57.07, -95.41);
rr_renderer_bezier_curve_to(renderer, 28.41, -120.20, -72.30, -106.13, -103.00, -84.74);
rr_renderer_bezier_curve_to(renderer, -124.19, -69.98, -132.93, -37.74, -134.19, -14.97);
rr_renderer_bezier_curve_to(renderer, -135.35, 5.96, -126.61, 31.38, -114.49, 46.59);
rr_renderer_bezier_curve_to(renderer, -103.18, 60.79, -79.70, 60.11, -66.06, 75.32);
rr_renderer_bezier_curve_to(renderer, -47.97, 95.50, -45.58, 158.39, -25.02, 165.61);
rr_renderer_bezier_curve_to(renderer, -6.34, 172.18, 32.34, 147.06, 48.04, 128.68);
rr_renderer_bezier_curve_to(renderer, 62.53, 111.69, 69.38, 62.19, 69.38, 62.19);
rr_renderer_bezier_curve_to(renderer, 69.38, 62.19, 69.38, 62.19, 69.38, 62.18);
rr_renderer_begin_path(renderer);
rr_renderer_move_to(renderer, -24.20, -5.85);
rr_renderer_bezier_curve_to(renderer, -24.20, -5.85, -32.17, 26.24, -40.61, 38.47);
rr_renderer_bezier_curve_to(renderer, -48.62, 50.06, -72.63, 66.38, -72.63, 66.38);
rr_renderer_begin_path(renderer);
rr_renderer_move_to(renderer, -34.46, 27.03);
rr_renderer_bezier_curve_to(renderer, -34.46, 27.03, -15.14, 52.23, -0.81, 59.86);
rr_renderer_bezier_curve_to(renderer, 15.99, 68.79, 62.40, 72.99, 62.40, 72.99);
           rr_renderer_fill(renderer);
            rr_renderer_stroke(renderer);
            break;
                                   ...
                                   uint8_t rarity, uint8_t flags)
{
    ...
    if (count <= 1)
    {
        ...
        else if (id == rr_petal_id_pollen)
            rr_renderer_rotate(renderer, 0.2f);
    ...
    else
    {
        ...
        for (uint32_t i = 0; i < count; ++i)
        {
            ...
            if (id == rr_petal_id_shell)
                ...
                rr_renderer_rotate(renderer, -1.0f);
            else if (id == rr_petal_id_starfish)
